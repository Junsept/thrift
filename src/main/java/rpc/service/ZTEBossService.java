              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.cmd = new ArrayList<String>(_list64.size);
                  String _elem65;
                  for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                  {
                    _elem65 = iprot.readString();
                    struct.cmd.add(_elem65);
                  }
                  iprot.readListEnd();
                }
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.cmd = new ArrayList<String>(_list69.size);
            String _elem70;
            for (int _i71 = 0; _i71 < _list69.size; ++_i71)
            {
              _elem70 = iprot.readString();
              struct.cmd.add(_elem70);
            }
          }
          struct.setCmdIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<Result>(_list72.size);
                  Result _elem73;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, connectAndExcute_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Result _iter75 : struct.success)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Result _iter76 : struct.success)
            {
              _iter76.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<Result>(_list77.size);
            Result _elem78;
